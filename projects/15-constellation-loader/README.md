...
#Twinkle---微凉 从该B站up学习，源码来源于其公众号
#个人评价是实现的还可以，有趣味，但效果细看并不精致，很多地方都值得优化，比如星星的发光变化，和具体的线条位置是否精确这些，包括下方的文字提示，都是值得进一步去改进的，我目前只学习了思路，还未在基础上改进，因为我觉得时间有点长，适合做展示，不适合做loding，所以先放着了。